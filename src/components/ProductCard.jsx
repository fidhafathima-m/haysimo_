...
export default function ProductCard({ product, index = 0, onClick }) {
  ...
  className={`group relative h-full flex flex-col rounded-3xl bg-white border border-horizon-100 p-6 shadow-card hover:shadow-soft transition-shadow duration-500 ${
...
>
  ...
  <div className="relative h-52 sm:h-60 shrink-0 rounded-2xl bg-mist overflow-hidden">
    <ImageWithFallback
      src={product.image}
  ...
  <div className="mt-6 flex flex-col flex-1">
    <div className="flex items-start justify-between gap-2">
      <div>
        ...
        <p className="text-sm text-horizon-600 font-medium mt-0.5">
          {product.variant}
        </p>
      </div>
